...
export const ItemProvider = ({ children }) => {
	const [items, setItems] = useState([
		...
		},
		{
			...
			condition: "Excellent",
			available: true,
			image: "https://m.media-amazon.com/images/I/71iVdP6-6+L.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Very Good",
			available: true,
			image: "https://m.media-amazon.com/images/I/81sYIwhV5UL.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Good",
			available: false,
			image: "https://m.media-amazon.com/images/I/81NjbwDNbvL.jpg",
		...
		},
		{
			...
			condition: "Good",
			available: true,
			image: "https://m.media-amazon.com/images/I/71b4+xd7f4L.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Very Good",
			available: true,
			image: "https://m.media-amazon.com/images/I/61Cz8XtVkQL.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Good",
			available: false,
			image: "https://m.media-amazon.com/images/I/71I+fpmrHAL.jpg",
			borrowedBy: "Sonal",
			sold: false,
		},
		{
			...
			condition: "Excellent",
			available: true,
			image: "https://m.media-amazon.com/images/I/61sIKUenYDL.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Like New",
			available: true,
			image: "https://m.media-amazon.com/images/I/71dCP9qt0FL.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Good",
			available: true,
			image: "https://m.media-amazon.com/images/I/71drWZZfthL.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Good",
			available: true,
			image: "https://m.media-amazon.com/images/I/71PdJ-Qy1cL.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Very Good",
			available: true,
			image: "https://m.media-amazon.com/images/I/61PDzYb1A2L.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Excellent",
			available: true,
			image: "https://m.media-amazon.com/images/I/61tG44aDK-L.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Very Good",
			available: true,
			image: "https://m.media-amazon.com/images/I/71Oey0JePoL.jpg",
			borrowedBy: null,
			sold: false,
		},
		{
			...
			condition: "Good",
			available: true,
			image: "https://m.media-amazon.com/images/I/61VTRlMBiKL.jpg",
			borrowedBy: null,
			sold: false,
		},
	]);
